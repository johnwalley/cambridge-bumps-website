...
const latest = [
  ...
  },
  {
    name: "Torpids",
    description:
      "Over 130 men's and women's crews race for their colleges in six men's divisions and five women's.",
    href: "#",
    icon: ChatAlt2Icon,
  },
  {
  ...
  return (
    <div className="bg-white">
      <Head>
        ...
        <meta name="description" content="Cambridge Bumps" />
        ...
        <Popover className="relative bg-white">
          <div className="flex justify-between items-center max-w-7xl mx-auto px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
            <div className="flex justify-start lg:w-0 lg:flex-1">
              <a href="#">
                <span className="sr-only">Cambridge Bumps</span>
                <img
            ...
            <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
              <div className="absolute inset-0">
                <img
                  ...
                  src="https://www.cambridgebumps.com/static/how-a75935853a4dce80480071702fd805a1.png"
